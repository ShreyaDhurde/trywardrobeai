...
input_prompt = """
You are going to convert all the English text into Hindi language, and you have to make sure that you understand each and every sentence and do not omit anythingor reduce anythingIf you don't understand anything, you are going toask
