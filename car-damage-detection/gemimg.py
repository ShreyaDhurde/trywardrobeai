    ...
    if uploaded_file is not None:
        ...
        if st.button("Generate!"):
            try:
                ...
                content_parts = [
                    glm.Part(text="Write a short analysis of the vehicle in this image. Describe the make, model, color, and any visible damage or unique features."),
